    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.periode-akademik.update', $periodeAkademik) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full" 
                                    :value="old('nama', $periodeAkademik->nama)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tahun_akademik" name="tahun_akademik" type="text" 
                                    ...
                                    :value="old('tahun_akademik', $periodeAkademik->tahun_akademik)" required />
                            ...
                            <div>
                                ...
                                <select id="semester" name="semester" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                    <option value="ganjil" {{ old('semester', $periodeAkademik->semester) == 'ganjil' ? 'selected' : '' }}>Ganjil</option>
                                    <option value="genap" {{ old('semester', $periodeAkademik->semester) == 'genap' ? 'selected' : '' }}>Genap</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_mulai" name="tanggal_mulai" type="date" 
                                    class="mt-1 block w-full" :value="old('tanggal_mulai', $periodeAkademik->tanggal_mulai->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_selesai" name="tanggal_selesai" type="date" 
                                    class="mt-1 block w-full" :value="old('tanggal_selesai', $periodeAkademik->tanggal_selesai->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="krs_mulai" name="krs_mulai" type="date" 
                                    class="mt-1 block w-full" :value="old('krs_mulai', $periodeAkademik->krs_mulai->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="krs_selesai" name="krs_selesai" type="date" 
                                    class="mt-1 block w-full" :value="old('krs_selesai', $periodeAkademik->krs_selesai->format('Y-m-d'))" required />
                        ...
                        <div class="mt-6">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_active" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" 
                                    {{ old('is_active', $periodeAkademik->is_active) ? 'checked' : '' }}>
